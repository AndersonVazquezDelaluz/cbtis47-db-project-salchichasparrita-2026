...
In this report, I will explain the normalization process of my ER diagram for a restaurant database system. During my conversation, I analyzed my tables to check if they follow the Third Normal Form (3NF). I made several corrections to improve the structure of the database and remove problems like redundant data and derived attributes.
