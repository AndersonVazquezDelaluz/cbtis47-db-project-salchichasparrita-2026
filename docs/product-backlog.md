...
**Proyecto:** Chicaffe - Cafeteria Management System
...
**Versión:** 1.2 | **Fecha:** May 14, 2026

---

## Resumen de Sprints

| Sprint | Epica | Parcial | Historias de usuario | Story Points |
|--------|-------|---------|----------------------|:------------:|
...
| Sprint | Story Points | SP Acumulados |
|--------|:------------:|:-------------:|
